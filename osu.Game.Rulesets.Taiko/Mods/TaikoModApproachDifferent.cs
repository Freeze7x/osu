...
{
    public class TaikoModApproachDifferent : Mod, IApplicableToDrawableHitObject, IApplicableToDrawableRuleset<TaikoHitObject>
    {
        public override string Name => "Approach Different";
        public override string Acronym => "AD";
        public override LocalisableString Description => "The hit objects are tweaking whar????";
        ...
        public void ApplyToDrawableHitObject(DrawableHitObject drawable)
        {
            drawable.ApplyCustomUpdateState += (drawableObject, _) =>
            {
                ...
                using (drawableObject.BeginAbsoluteSequence(start))
                {
                    ...
                    drawableObject.MoveToX(0, duration, getEasing(Style.Value));
                }
            };
        }
